...
class ErrorsTest extends TestCase
{
    ...
    public function testLetters()
    {
        ...
        $this->assertEquals(['password' => ['The password must include at least one letter.']], $validated);
    }
    ...
    public function testCaseDiff()
    {
        ...
        $this->assertEquals(['password' => ['The password must include both upper and lower case letters.']], $validated);
    }
    ...
    public function testNumbers()
    {
        ...
        $this->assertEquals(['password' => ['The password must include at least one number.']], $validated);
    }
    ...
    public function testSymbols()
    {
        ...
        $this->assertEquals(['password' => ['The password must include at least one symbol.']], $validated);
    }

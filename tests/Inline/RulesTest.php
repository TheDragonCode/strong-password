...
final class RulesTest extends InlineTestCase
{
    ...
    public function testLetters()
    {
        ...
        $this->assertSame('This field must include at least one letter.', $result->errors()->first());
    }
    ...
    public function testCaseDiff()
    {
        ...
        $this->assertTrue($result->fails());
        $this->assertCount(1, $result->errors()->all());
        $this->assertSame('This field must include both upper and lower case letters.', $result->errors()->first());
    ...
    public function testNumbers()
    {
        ...
        $this->assertTrue($result->fails());
        $this->assertCount(1, $result->errors()->all());
        $this->assertSame('This field must include at least one number.', $result->errors()->first());
    ...
    public function testSymbols()
    {
        ...
        $this->assertTrue($result->fails());
        $this->assertCount(1, $result->errors()->all());
        $this->assertSame('This field must include at least one symbol.', $result->errors()->first());
    ...
    public function testMinLength()
    {
        ...
        $this->assertTrue($result->fails());
        $this->assertCount(1, $result->errors()->all());
        $this->assertSame('This field must be at least ten characters.', $result->errors()->first());
    ...
    public function testStrong()
    {
        ...
        $this->assertCount(1, $result->errors()->all());
        $this->assertSame(
            'This field must contain at least two characters in lower and upper case, at least one digit and special character, and also have a length of at least ten characters.',
            $result->errors()->first()
        );
